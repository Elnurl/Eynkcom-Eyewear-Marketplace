---
name: Marketplace launch area
description: Geographic boundary for the initial real-order launch.
---

The first real-order launch should accept orders in Bakı and Abşeron only; nationwide ordering can be considered later.
...
From the first day, buyers should alternatively be able to pick up the order from the selling optical shop for free.

Whether a buyer may pay in the shop when picking up is deliberately undecided until the owner agrees on terms with partner shops. Free pickup does not by itself imply pay-at-shop.
