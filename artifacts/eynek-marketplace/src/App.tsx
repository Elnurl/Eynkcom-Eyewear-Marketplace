  ...
  return (
    <>
      <main className="home-page">
        ...
        <section className="section" style={{ paddingTop: 0 }}><div className="container seller-banner"><h2>Mağazanızı <span className="banner-brand-word"><img src={`${import.meta.env.BASE_URL}eynek-name.png`} alt="EYNƏK" />-ə</span> gətirin.</h2><Link href="/seller" className="btn" data-testid="link-home-seller">Partnyor ol <ArrowRight size={14} /></Link></div></section>
      </main>
      <Footer />
    </>
  );
